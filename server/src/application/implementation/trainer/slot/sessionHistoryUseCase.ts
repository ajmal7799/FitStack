...
export class SessionHistoryUseCase implements ISessionHistoryUseCase {
    ...
    async getTrainerSessionHistory(trainerId: string, page: number, limit: number, search?: string): Promise<{ sessions: SessionHistoryTrainerResult[]; totalSessions: number; totalPages: number; currentPage: number; }> {
