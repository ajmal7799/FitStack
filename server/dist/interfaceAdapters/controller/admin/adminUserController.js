...
class AdminUserController {
    constructor(_getAllUserUseCase, _updateUserStatusUseCase) {
    ...
    getAllUsers(req, res, next) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                const result = yield this._getAllUserUseCase.getAllUser(page, limit, status, search);
    ...
    updateUserStatus(req, res, next) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                const result = yield this._updateUserStatusUseCase.updateUserStatus(userId, currentStatus);
