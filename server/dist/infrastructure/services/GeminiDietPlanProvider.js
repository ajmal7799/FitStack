...
exports.GeminiDietProvider = void 0;
const config_1 = require("../config/config");
const generative_ai_1 = require("@google/generative-ai");
class GeminiDietProvider {
    constructor() {
...
- Balance all macronutrients`,
    ...
    getGoalGuidance(goal, weightChange) {
...
exports.GeminiDietProvider = GeminiDietProvider;
