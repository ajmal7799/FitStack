...
exports.GeminiWorkoutProvider = void 0;
const config_1 = require("../config/config");
const generative_ai_1 = require("@google/generative-ai");
class GeminiWorkoutProvider {
    constructor() {
        const apiKey = config_1.CONFIG.GEMINI_API_KEY;
    ...
    buildWorkoutPrompt(profile) {
        ...
        const medicalConditions = profile.medicalConditions && profile.medicalConditions.length > 0 ? profile.medicalConditions.join(', ') : 'none';
        // Format preferred workout types
        const preferredWorkoutTypes = profile.preferredWorkoutTypes && profile.preferredWorkoutTypes.length > 0
...
Based on preferred workout types (${((_a = profile.preferredWorkoutTypes) === null || _a === void 0 ? void 0 : _a.join(', ')) || 'mixed'}):
...
Generate the complete workout plan now in the exact JSON format specified above.`;
    ...
    getGoalSpecificGuidelines(goal) {
        const guidelines = {
...
- Include balance and coordination exercises`,
    ...
    getWorkoutTypeGuidelines(types) {
        const guidelines = {
    ...
    getExperienceLevelDetails(level) {
        const details = {
...
exports.GeminiWorkoutProvider = GeminiWorkoutProvider;
