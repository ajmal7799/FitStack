      ...
      <div className="max-w-7xl mx-auto px-6 md:px-12 py-12">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed">
            Browse our certified trainers and discover the perfect coach for your fitness journey. 
            Subscribe to unlock access and connect with your ideal trainer!
          </p>
          {totalTrainers > 0 && (
        ...
        {isLoading && (
          <div className="flex justify-center items-center py-20">
            <div className="text-center">
              ...
              <p className="text-gray-600 font-medium text-lg">Loading trainers...</p>
            </div>
          </div>
        )}
                  ...
                  <div className="p-6">
                    ...
                    {trainer.qualification && (
                      <div className="bg-purple-50 border border-purple-100 rounded-lg p-3 mb-3">
                        <p className="text-xs text-purple-600 font-semibold mb-1 uppercase">Qualification</p>
                        <p className="text-sm text-gray-700 font-medium">{trainer.qualification}</p>
                      </div>
                    )}
                    ...
                    <div className="grid grid-cols-2 gap-3 mb-4">
                      ...
                      {trainer.experience && (
                        <div className="bg-gray-50 rounded-lg p-3 text-center">
                          ...
                          <p className="font-bold text-gray-900">{trainer.experience} Years</p>
                        </div>
                      )}
                      ...
                      {trainer.rating && (
                        <div className="bg-gray-50 rounded-lg p-3 text-center">
                          ...
                          <p className="font-bold text-gray-900">{trainer.rating}/5.0</p>
                        </div>
                      )}
                      ...
                      {trainer.location && (
                        <div className="bg-gray-50 rounded-lg p-3 text-center col-span-2">
                          <div className="flex items-center justify-center text-gray-700">
                            ...
                            <p className="text-sm font-semibold">{trainer.location}</p>
                          </div>
                        </div>
                      )}
                    </div>
                    ...
                    <div className="bg-gradient-to-r from-blue-50 to-purple-50 border-2 border-blue-200 rounded-xl p-4 text-center">
                      ...
                      <p className="text-xs text-gray-600 mb-3">
                        Subscribe to unlock access to your favorite trainers and start your transformation!
                      </p>
                      <button
                        onClick={() => handleViewProfile('/subscription')}
                        className="w-full py-2.5 bg-gradient-to-r from-blue-600 to-purple-600 text-white rounded-full hover:shadow-lg transition duration-300 font-semibold text-sm"
                      >
        ...
        <div className="mt-16 bg-white rounded-3xl shadow-2xl p-12">
          <h2 className="text-4xl font-extrabold text-center text-gray-900 mb-12">
            Why Choose Our <span className="text-blue-600">Certified Trainers</span>
          </h2>
          <div className="grid md:grid-cols-4 gap-8">
            <div className="text-center">
              ...
              <p className="text-gray-600 text-sm">All trainers are certified and verified</p>
            </div>
            <div className="text-center">
              ...
              <p className="text-gray-600 text-sm">Daily video calls except Sunday</p>
            </div>
            <div className="text-center">
              ...
              <p className="text-gray-600 text-sm">Chat anytime with your trainer</p>
            </div>
            <div className="text-center">
              ...
              <p className="text-gray-600 text-sm">Experts in various fitness domains</p>
            </div>
          </div>
        </div>
        ...
        <div className="mt-16 bg-gradient-to-r from-blue-600 to-purple-600 rounded-3xl shadow-2xl p-12 text-center text-white">
          ...
          <p className="text-xl mb-8 text-blue-100">
            Subscribe now to unlock access to all trainers and start your personalized fitness journey!
          </p>
          <button 
            onClick={() => handleViewProfile('/subscription')}
