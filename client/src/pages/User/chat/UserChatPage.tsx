...
const UserChatPage = () => {
  ...
  const handleReceiveMessage = useCallback((message: Message) => {
    console.log('📥 Global message received (User side):', message);
    ...
    // 1. The chat is not currently selected/open
  ...
  const currentChat = useMemo(() => {
    ...
    return {
      ...
      unreadCount: selectedChatId === baseChat.chatId ? 0 : (baseChat.unreadCount + localUnreadCount),
    };
              ...
              <div className="flex-1 flex items-center justify-center bg-white">
                <div className="text-center p-8">
                  ...
                  <h3 className="text-xl font-semibold text-gray-700 mb-2">
                    {isLoading ? 'Connecting...' : currentChat ? 'Select a chat to start' : 'No trainer assigned yet'}
                  </h3>
