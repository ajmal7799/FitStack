      ...
      <div className="bg-white rounded-2xl border border-gray-100 shadow-sm p-6 sm:p-8">
        <div className="flex flex-col sm:flex-row items-center sm:items-start gap-6">
          ...
          <div className="flex-1 space-y-3 w-full">
            ...
            <div className="h-7 bg-gray-100 rounded-full w-24 mx-auto sm:mx-0" />
          </div>
        </div>
      </div>
...
// ── Main Page ────────────────────────────────────────────────────────────────
const SessionHistoryDetailsPage = () => {
      ...
      <div className="flex-1 flex flex-col min-w-0 h-screen overflow-hidden">
        ...
        <main className="flex-1 overflow-y-auto overflow-x-hidden p-4 sm:p-6 lg:p-10">
          ...
          <motion.button
            ...
            onClick={() => navigate(-1)}
            className="inline-flex items-center gap-2 text-sm font-medium text-blue-600 hover:text-blue-800 mb-6 group transition-colors"
          >
            <span className="w-7 h-7 rounded-full bg-white border border-blue-100 shadow-sm flex items-center justify-center group-hover:bg-blue-50 transition-colors">
          ...
          {isError && !isLoading && (
            ...
            >
              ...
              <p className="text-base font-semibold text-gray-600">Failed to load session details</p>
              <p className="text-sm mt-1">Please try again or go back.</p>
            </motion.div>
          )}
          ...
          {!isLoading && !isError && session && (
            <motion.div variants={pageVariants} initial="hidden" animate="show" className="space-y-5">
              ...
              {/* ── Hero Card ──────────────────────────────────────────────── */}
              <motion.div variants={heroVariants} className="bg-white rounded-2xl border border-emerald-100 shadow-sm overflow-hidden">
                ...
                <div className="p-6 sm:p-8">
                  <div className="flex flex-col sm:flex-row items-center sm:items-start gap-5">
                    ...
                    <div className="relative flex-shrink-0">
                      {session.profileImage ? (
                        ...
                        <div className="w-20 h-20 sm:w-24 sm:h-24 rounded-full bg-gradient-to-br from-emerald-500 to-emerald-700 text-white flex items-center justify-center text-3xl font-bold uppercase shadow-md border-4 border-white">
                    ...
                    <div className="flex-1 text-center sm:text-left min-w-0">
                      <p className="text-xs font-semibold text-emerald-500 uppercase tracking-widest mb-1">Trainer</p>
                      <h1 className="text-xl sm:text-2xl font-bold text-gray-900 capitalize">{session.trainerName}</h1>
                      <p className="text-sm text-gray-500 mt-1 break-all">{session.trainerEmail}</p>
                    ...
                    <div className="hidden sm:flex flex-col items-center bg-emerald-50 border border-emerald-100 rounded-2xl px-5 py-4 flex-shrink-0">
                      <p className="text-xs font-semibold text-emerald-500 uppercase tracking-wide">Duration</p>
                  ...
                  {/* Duration — mobile */}
                  <div className="flex sm:hidden items-center justify-center gap-2 mt-4 bg-emerald-50 border border-emerald-100 rounded-xl py-3 px-4">
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-5">
                ...
                <motion.div variants={cardVariants} className="bg-white rounded-2xl border border-gray-100 shadow-sm p-6">
                  <div className="flex items-center gap-2 mb-4">
                    ...
                    <h2 className="text-sm font-bold text-gray-800 uppercase tracking-wide">Trainer Info</h2>
                  </div>
                  <InfoRow
                    icon={<svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z" /></svg>}
                    label="Trainer Name" value={session.trainerName}
                  />
                  <InfoRow
                    icon={<svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" /></svg>}
                    label="Trainer Email" value={session.trainerEmail}
                  />
                  <InfoRow
              ...
              {/* ── Feedback Card — always shown for completed sessions ─────── */}
              <motion.div
              ...
              >
                ...
                <div className="p-6">
                  <div className="flex items-center gap-2 mb-5">
                    ...
                    <h2 className="text-sm font-bold text-gray-800 uppercase tracking-wide">Your Feedback</h2>
                  </div>
                  ...
                  {hasFeedback ? (
                    ...
                    <div className="flex flex-col items-center py-6 gap-3 text-gray-400">
                      ...
                      <p className="text-xs text-gray-400 text-center">
                        You can rate this session from the booking details page.
                      </p>
                    </div>
                  )}
                </div>
...
export default SessionHistoryDetailsPage;