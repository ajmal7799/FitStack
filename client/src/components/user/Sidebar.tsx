        ...
        <div className="fixed bottom-0 lg:absolute w-72 lg:w-64 p-4 bg-blue-950 border-t border-blue-700">
          <div className="flex items-center gap-3 px-2">
            ...
            <div className="flex-1 min-w-0">
              <p className="text-sm font-medium text-white truncate">{userData.name || 'User Name'}</p>
              <p className="text-xs text-blue-300 truncate">{userData.email || 'user@example.com'}</p>
            </div>
          </div>
        </div>
      </aside>
